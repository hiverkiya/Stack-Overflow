...
public class AnswerBusinessService {
  ...
  public QuestionEntity getQuestionByUuid(String Uuid)
    ...
    if (questionEntity == null) {
      throw new InvalidQuestionException(
          "QUES-001", "question with this user id does not exist in database");
    }
  ...
  public AnswerEntity editAnswerContent(AnswerEntity answerEntity,
                                        String answerId, String authorization)
    ...
    if (userAuthEntity == null) {
      ...
      if (answerEntity1 == null) {
        throw new AnswerNotFoundException(
            "ANS-001", "answer with this user id does not exist in database");
   ...
   */
  @Transactional(propagation = Propagation.REQUIRED)
  public AnswerEntity deleteAnswer(String answerId, String authorization)
      throws AuthorizationFailedException, AnswerNotFoundException {
    UserAuthEntity userAuthEntity =
        userDao.getUserAuthByAccesstoken(authorization);
    if (userAuthEntity == null) {
  ...
  /**
   * The method implements the business logic for getAllAnswersToQuestion
   * endpoint.
   */
  public TypedQuery<AnswerEntity> getAnswersByQuestion(String questionId,
                                                       String authorization)
    ...
    if (userAuthEntity == null) {
      ...
      QuestionEntity questionEntity =
          this.answerDao.getQuestionByUuid(questionId);
      if (questionEntity == null) {
        throw new InvalidQuestionException(
            "QUES-001", "question with this id does not exist in database");
      } else {
