...
/**
 * This class contains all the test cases to test the AnswerController class.
 */
...
public class AnswerControllerTest {
    ...
    public void editAnswerWithoutOwnership() throws Exception {
        mvc.perform(MockMvcRequestBuilders.put("/answer/edit/database_answer_uuid?content=edited_answer").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("authorization", "database_accesstoken2"))
                .andExpect(status().isForbidden())
